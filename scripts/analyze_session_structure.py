...
try:
    ...
    if expenses:
        ...
        session_fields = [f for f in all_fields if 'session' in f.lower() or 'client' in f.lower() or 'receipt' in f.lower()]
        ...
        pricing_fields = [f for f in all_fields if 'price' in f.lower() or 'margin' in f.lower() or 'payment' in f.lower() or 'deposit' in f.lower()]
        ...
        for i, record in enumerate(expenses[:2], 1):
            ...
            key_fields = ['date', 'merchant', 'total', 'currency', 'category',
                         'client', 'session_id', 'session_status', 'receipt_id',
                         'Payment Status', 'Guests', 'Service Type', 'Event Type']
