...
sftp = ssh.open_sftp()
sftp.put(r'C:\Users\ASUS\sessions_dashboard.html', '/tmp/sessions.html')
sftp.close()

print('✅ Uploaded to /tmp')

# Move to web directory with sudo
print('📝 Moving to web directory...')
stdin, stdout, stderr = ssh.exec_command('echo MosesHappy182! | sudo -S mv /tmp/sessions.html /var/www/html/sessions.html')
stdout.channel.recv_exit_status()

# Set permissions
stdin, stdout, stderr = ssh.exec_command('echo MosesHappy182! | sudo -S chmod 644 /var/www/html/sessions.html')
stdout.channel.recv_exit_status()

print('✅ Moved and permissions set!\n')
